        ...
        <div class="bg-gray-100 font-sans w-full  m-0">
            ...
            <div class="container mx-auto px-4">
              <div class="flex items-center justify-between py-4">
                <div>
                    <strong class="text-2xl">DiscoverWorld</strong>
                </div>
    ...
    <div class="mb-4">
        ...
        <select id="destination" name="destination"
            ...
            @foreach($destinations as $destination)
                <option id="des-btn" value="{{ $destination->id }}">{{ $destination->DestinationName }}</option>
            @endforeach
        </select>
    </div>
                ...
                <a rel="noopener noreferrer" href="#" class="border-2 rounded-2xl max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-900">
                  ...
                  @endforeach
                   <div class="p-6 space-y-2">
                    ...
                    <input type="hidden" name="user" value="{{$recit->UserId}}">
